...
contains
  ...
  subroutine MP5limiter(ixI^L,iL^L,idims,w,wLC,wRC)
    ...
    double precision, parameter     :: eps=1.0d-15, alpha=4.0d0
  ...
  subroutine MP5limiterL(rec_from,rec_to,ixI^L,iL^L,idims,w,wLC)
    ...
    double precision, intent(inout) :: wLC(ixI^S,1:nprim) 
    ! .. local ..
  ...
  subroutine MP5limiterR(rec_from,rec_to,ixI^L,iL^L,idims,w,wRC)
    ...
    double precision, intent(inout) :: wRC(ixI^S,1:nprim)
    ! .. local ..
