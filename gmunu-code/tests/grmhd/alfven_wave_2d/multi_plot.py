...
# Load the dataset
ds = yt.load('output0020.dat', unit_system='code')
...
ds.add_field( ('amrvac','veloc3'), function=veloc2, sampling_type='cell')
...
for i, field in enumerate(fields):
    ...
    p.annotate_streamlines('veloc1', 'veloc2', density = 0.5, factor = 10)
