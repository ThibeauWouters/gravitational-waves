...
df_TD = pd.read_csv("point_data.csv", delimiter = '\t', usecols = ['t','rho','psi','alp','vel1','vel2','vel3','v1','v2','v3'])
df_TD = df_TD[['t','rho','psi','alp','vel1','vel2','vel3','v1','v2','v3']]
...
data_t1 = interp1d(df_TD['t'], df_TD['v1'], kind = 'cubic')
data_t2 = interp1d(df_TD['t'], df_TD['v2'], kind = 'cubic')
...
df_FD.to_csv('vel_FD.csv', index = False, sep = '\t')
