...
# Load the dataset
ds = yt.load('output0005.dat', geometry_override='cylindrical', unit_system='code')
...
fields=['rho','B_tor','B2_pol','B2_tor']
plot_width = 30
plot_height = 30
...
p.set_log('Evec1', False)
p.set_log('Evec2', False)
p.set_log('Evec3', False)
