...
# read data
#it global_time dt rho_max alp_min M_rest I11_dot I12_dot I22_dot
data_time, data_I11_dot, data_I22_dot = np.loadtxt(filepath+"output.log", unpack=True ,dtype='float',usecols=(1,6,8),skiprows=1)
...
h_plus = I11_ddot - 2.0 * I22_ddot # fixme: this is not real hp
